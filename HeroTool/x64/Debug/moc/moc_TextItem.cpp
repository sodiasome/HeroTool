...
QT_MOC_LITERAL(1, 9, 10), // "EditStatus"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "TextItem\0EditStatus\0"
};
...
void TextItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TextItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (TextItem::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextItem::EditStatus)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TextItem::EditStatus(bool _t1)
{
